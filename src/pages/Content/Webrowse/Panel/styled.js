...
const StyledWrapper = styled.aside`
  ...
  .panel {
    ...
    /* background-color: var(--webrowse-panel-bg-color); */
    background: var(--webrowse-panel-bg-color);
    font-size: 10px;
  ...
  /* &:hover {
    .panel {
      background-color: var(--webrowse-panel-bg-color) !important;
    }
  } */
  &.resizing .panel {
    background: var(--webrowse-panel-bg-color) !important;
  }
`;
