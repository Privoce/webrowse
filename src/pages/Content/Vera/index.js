...
const GlobalStyle = createGlobalStyle`
  ...
  :root {
      --vera-widget-bg-color: #056CF2;
      --vera-theme-color:#056CF2;

      --vera-control-disable-color:#d2d2d2;
      --vera-popup-bg-color:#fff;
      --vera-panel-bg-color: radial-gradient( circle at top left, rgba(255,255,255,0.8) 20px, #ffffff90 100px ), radial-gradient( circle at top right, rgba(255,255,255,0.8) 20px, #ffffff90 104px ), radial-gradient( at bottom left, #a788f3 100px, transparent 411px ), radial-gradient( at bottom right, #8994f5 200px, transparent 400px );
      --vera-panel-border-radius: 15px;
      --vera-box-bg-color:#fff;
      --vera-button-bg-color: #056CF2;
      ...
      --vera-border-radius: 20px;
    }
  .vera-dark-theme{
    --vera-theme-color:#85d4db;
    --vera-panel-bg-color: #000;
    --vera-box-bg-color:#616161;

    --vera-popup-bg-color:#DBE2EB;
    --vera-button-bg-color: #68D6DD;
