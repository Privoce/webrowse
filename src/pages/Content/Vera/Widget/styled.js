  ...
  .widget {
    ...
    .drag {
      ...
      > .portal_logo {
        ...
        background-image: url(${`chrome-extension://${chrome.runtime.id}/assets/icon/logo.png`});
      ...
      > .handle {
        ...
        width: 12px;
        height: 30px;
        background-image: url(${`chrome-extension://${chrome.runtime.id}/assets/icon/drag-vertical.svg`});
